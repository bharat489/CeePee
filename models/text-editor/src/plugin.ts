...
export default mergeIds(textEditorId, textEditor, {
  function: {
    ...
    AiExpand: '' as Resource<TextActionFunction>,
    AiFormal: '' as Resource<TextActionFunction>,
    AiCasual: '' as Resource<TextActionFunction>,
    AiSummarize: '' as Resource<TextActionFunction>,
    AiOutline: '' as Resource<TextActionFunction>,
    AiActionItems: '' as Resource<TextActionFunction>,
    AiContinue: '' as Resource<TextActionFunction>,
    AiTranslate: '' as Resource<TextActionFunction>,
    AiAsk: '' as Resource<TextActionFunction>,
