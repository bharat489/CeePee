...
export default mergeIds(trackerId, tracker, {
  ...
  actionImpl: {
    ...
    CloneWithSubIssues: '' as ViewAction,
    BulkChange: '' as ViewAction,
    RemindMe: '' as ViewAction,
    ShareIssue: '' as ViewAction,
    ArchiveIssue: '' as ViewAction,
    UnarchiveIssue: '' as ViewAction,
    Move: '' as ViewAction,
  ...
  action: {
    ...
    CloneWithSubIssues: '' as Ref<Action>,
    BulkChange: '' as Ref<Action>,
    RemindMe: '' as Ref<Action>,
    ShareIssue: '' as Ref<Action>,
    ArchiveIssue: '' as Ref<Action>,
    UnarchiveIssue: '' as Ref<Action>,
