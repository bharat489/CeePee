...
export default plugin(textEditorId, {
  ...
  string: {
    ...
    AiExpand: '' as IntlString,
    AiFormal: '' as IntlString,
    AiCasual: '' as IntlString,
    AiSummarize: '' as IntlString,
    AiOutline: '' as IntlString,
    AiActionItems: '' as IntlString,
    AiContinue: '' as IntlString,
    AiTranslate: '' as IntlString,
    AiAsk: '' as IntlString,
